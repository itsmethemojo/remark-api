...
| https://itsmethemojo.github.io/helm-charts/ | app(basic-web-app) | 1.3.0 |
...
| app.env.API_PATH_PREFIX | string | `"api/"` | see [default.env](https://github.com/itsmethemojo/remark-api/blob/master/default.env) |
...
| app.image.tag | string | `"sha-28d2e51"` |  |
